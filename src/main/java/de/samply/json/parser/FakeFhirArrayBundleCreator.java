...
import de.samply.bundleloader.Neo4jBundleLoader;
...
public class FakeFhirArrayBundleCreator {
    ...
    public static void main(String[] args) throws IOException {
        new FakeFhirArrayBundleCreator().create();
    }
    ...
    private Patient createPatient(int countPatient) {
    ...
    private List<Observation> createObservations(int countPatient) {
    ...
    private Observation createObservation(int countObservation, int countPatient) {
        String observationId = countPatient + "_" + countObservation;
    ...
    private Path createPath(String praefix, String id) {
        return Paths.get("DIR_IMPORT", praefix + StringUtils.leftPad(id, PADDING_SIZE, "0") + SUFFIX_JSON);
    }
